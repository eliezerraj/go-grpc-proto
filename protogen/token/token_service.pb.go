...
const file_proto_token_token_service_proto_rawDesc = "" +
	"\n" +
	"\x1fproto/token/token_service.proto\x12\x05token\x1a\x19proto/token/pod/pod.proto\x1a\x1bproto/token/card/card.proto\x1a!proto/token/payment/payment.proto\x1a\x1fproto/token/health/health.proto2\xa1\x03\n" +
	"\fTokenService\x121\n" +
	...
	"\fGetCardToken\x12\x17.token.CardTokenRequest\x1a\x1c.token.ListCardTokenResponse\"\x00\x12G\n" +

...
const (
	PodService_GetPod_FullMethodName = "/pod.PodService/GetPod"
)
...
func (c *podServiceClient) GetPod(ctx context.Context, in *PodRequest, opts ...grpc.CallOption) (*PodResponse, error) {
...
func (UnimplementedPodServiceServer) GetPod(context.Context, *PodRequest) (*PodResponse, error) {
...
func _PodService_GetPod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodServiceServer).GetPod(ctx, req.(*PodRequest))
	}
...
var PodService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/pod/pod_service.proto",
}
